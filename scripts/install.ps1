...
param(
    [string]$InstallRoot = "",
    [string]$RepoUrl = "https://github.com/Ada123-a/musubi-tuner-DoKr-SinkSGD_adv-TREAD.git",
    [string]$Branch = "ltx-2",
    [string]$RepoDir = "",
...
function Write-LauncherScript {
    ...
    $contents = @(
        ...
        "",
        "if not defined HOST set ""HOST=$HostValue""",
        "if not defined PORT set ""PORT=$PortValue""",
