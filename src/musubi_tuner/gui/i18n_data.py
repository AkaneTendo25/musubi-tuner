...
I18N_DATA = {
    "en": {
        ...
        "desc_model": "Choose the model architecture and specify the model directory. Image models expect a ComfyUI models folder; MOVA expects the official checkpoint root.",
        "lbl_model_arch": "Model Architecture",
        "lbl_vram": "VRAM Size (GB)",
        "lbl_comfy_dir": "Models Directory / Model Root",
        "ph_comfy_dir": "Absolute path to ComfyUI/models or a MOVA checkpoint root",
        ...
        "desc_training_mova": "MOVA expects the official checkpoint root as the model path. The GUI wires `video_dit`, optional `video_dit_2`, `audio_dit`, `dual_tower_bridge`, `video_vae`, and `text_encoder` automatically.",
...
""",
        ...
        "lbl_block_swap": "Block Swap (model-dependent)",
        ...
        "header_sample_images": "### Sample Generation",
        "lbl_enable_sample": "Generate Samples During Training",
    ...
    "ja": {
        ...
        "desc_model": "モデルアーキテクチャを選択し、モデルディレクトリを指定してください。画像モデルはComfyUIのmodelsフォルダ、MOVAは公式チェックポイントのルートを想定します。",
        "lbl_model_arch": "モデルアーキテクチャ",
        "lbl_vram": "VRAMサイズ (GB)",
        "lbl_comfy_dir": "モデルディレクトリ / モデルルート",
        "ph_comfy_dir": "ComfyUI/models または MOVA チェックポイントルートへの絶対パス",
        ...
        "desc_training_mova": "MOVAでは公式チェックポイントのルートをモデルパスに指定します。GUIが `video_dit`、任意の `video_dit_2`、`audio_dit`、`dual_tower_bridge`、`video_vae`、`text_encoder` を自動で扱います。",
...
""",
        "lbl_flow_shift": "Discrete Flow Shift",
        "lbl_block_swap": "Block Swap (モデル依存)",
        ...
        "header_sample_images": "### サンプル生成",
        "lbl_enable_sample": "学習中にサンプルを生成する",
