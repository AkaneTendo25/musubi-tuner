...
from musubi_tuner.ltx_2.model.video_vae.transformer.det_attn_rope import det_qkv_rope
from musubi_tuner.ltx_2.model.video_vae.transformer.qkv import QKVProjections
from musubi_tuner.ltx_2.model.video_vae.transformer.rope_math import (
...
class NattenAttention(NAAttentionCallable):
    ...
    def __call__(
        ...
        if not _NATTEN_AVAILABLE:
            raise ImportError("No neighborhood-attention backend was configured for the LTX-2.5 DiffVAE.")
