...
class CompilationConfig:
    ...
    dynamo_config: dict[str, Any] = field(default_factory=lambda: {"inline_inbuilt_nn_modules": True, "cache_size_limit": 256})
...
def configure_natten_backend(module_root: nn.Module, backend: str | None) -> None:
    ...
    auto-selection.
    """
    from musubi_tuner.ltx_2.model.video_vae.transformer.attention import (  # noqa: PLC0415
        NattenAttention,
...
def compile_diffusion_decoder(
    ...
    *,
    ...
    from musubi_tuner.ltx_2.model.video_vae.transformer.chunked.block import ChunkedDiffusionNABlock  # noqa: PLC0415
    from musubi_tuner.ltx_2.model.video_vae.transformer.combined.block import CombinedDiffusionNABlock  # noqa: PLC0415
    from musubi_tuner.ltx_2.model.video_vae.transformer.dsl_kernels.block import DSLDiffusionNABlock  # noqa: PLC0415
