...
from musubi_tuner.ltx_2.model.video_vae.transformer.fallback_na.eager import na3d as eager_na3d

if TYPE_CHECKING:
    from musubi_tuner.ltx_2.model.video_vae.transformer.attention import NAAttentionCallable, NeighborhoodAttention3D

logger = logging.getLogger(__name__)

_NO_NATTEN_WARNING = (
    "DiffVAE: optional NATTEN is unavailable; using the vendored Triton or pure-PyTorch tiled-SDPA neighborhood-attention fallback."
)
...
def na_attention_triton(
    ...
    from musubi_tuner.ltx_2.model.video_vae.transformer.fallback_na.triton_na import (  # noqa: PLC0415
        na3d as triton_na3d,
    )
