...
from musubi_tuner.ltx_2.model.video_vae.transformer.apply import resolve_attention_for_host
from musubi_tuner.ltx_2.model.video_vae.transformer.config import DiffVAEMode, NAttentionKind
...
from musubi_tuner.ltx_2.types import VIDEO_SCALE_FACTORS, SpatioTemporalScaleFactors
...
def stage4_feature_bytes(
    *,
    ...
    from musubi_tuner.ltx_2.types import VIDEO_SCALE_FACTORS, VideoLatentShape, VideoPixelShape  # noqa: PLC0415
...
def prepare_tile_schedule(
    ...
    *,
    ...
    t_split, h_split, w_split = tiling_config.to_splitters(pixel_scale, min_tile_size=min_tile_size, causal_temporal=False)
