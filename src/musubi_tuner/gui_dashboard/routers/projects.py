...
def _project_summary(config: ProjectConfig, path: Path) -> dict:
    ...
    return {
        ...
        "mode": training.h3_training_mode if training.model_type == "minimax_h3" else training.ltx2_mode,
        "ltx_version": training.ltx_version if training.model_type != "minimax_h3" else None,
        "lora_kind": lora_kind,
