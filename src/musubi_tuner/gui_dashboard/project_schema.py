...
class CachingConfig(BaseModel):
    ...
    h3_reference_video_fps: float = 0.0
    h3_loss_mask_pooling: Literal["max", "average", "nearest"] = "max"
...
class TrainingConfig(BaseModel):
    ...
    h3_dop_class_prompt: str = ""
    h3_dop_caption_mode: Literal["class", "bare"] = "class"
    h3_two_teacher_weights: str = ""
    h3_two_teacher_multiplier: float = 1.0
    h3_two_teacher_loss_weight: float = 0.0
    h3_two_teacher_bare_weight: float = 1.0
    ...
    h3_loss_mask_normalization: Literal["weighted", "full"] = "weighted"
    h3_guidance_audio_scale: Optional[float] = None
    reference_video_fps: float = 0.0
    h3_max_caption_tokens: int = 0
    h3_qwen_control_dropout_rate: float = 0.0
    h3_validation_field_probe: bool = False
    h3_validation_rollout_probe: int = 0
    h3_validation_rollout_stop: float = 0.5
    h3_profile_steps: int = 0
    h3_rollout_supervision: bool = False
    h3_rollout_teacher_config: Optional[str] = None
    h3_rollout_teacher_privilege: str = "auto"
    h3_rollout_probability: float = 0.5
    h3_rollout_steps: int = 2
    h3_rollout_window: int = 1
    h3_rollout_stop_shifted: bool = False
    h3_rollout_fused_teacher: bool = False
    h3_rollout_teacher_magnitude_weight: float = 1.0
    h3_rollout_field_floor: float = 0.0
    h3_guidance_scale_sigma_max: float = 1.0
    h3_validation_multipliers: str = ""
    h3_adapter_ema_decay: float = 0.0
    h3_validate_ema: bool = False
    h3_term_grad_every: int = 0
    h3_adapter_stats_every: int = 0
    h3_train_sigma_bins: bool = False
    h3_validation_bare_dataset_config: Optional[str] = None
    h3_validation_std: bool = False
    h3_adapter_prompt_only: bool = False
    h3_measured_variance_weighting: Optional[str] = None
    h3_measured_variance_weight_max: float = 4.0
    h3_rollout_stop_min: float = 0.0
    h3_rollout_prefix: Literal["student", "teacher"] = "student"
    h3_rollout_null_anchor_weight: float = 0.0
    ...
    save_request_file: Optional[str] = None
    save_and_stop_request_file: Optional[str] = None
...
class InferenceConfig(BaseModel):
    ...
    h3_fused_qk_norm_rope: bool = False
    h3_learned_context_multipliers: str = ""
    h3_null_guidance_scale: float = 0.0
    h3_inspect: bool = False
    vae: str = ""
