						...
						{#if t.model_type === 'minimax_h3'}
							...
							{#if $advancedMode}
								...
								<div class="h3-control-cluster">
									...
									<FormField type="number" fieldPath="training.h3_mask_min_fraction" value={t.h3_mask_min_fraction ?? 0.25} oninput={(e) => update('h3_mask_min_fraction', Number(e.target.value))} min={0} max={1} step="0.05" disabled={t.h3_mask_mode === 'off' && !t.h3_mask_audio} />
									<FormField type="number" fieldPath="training.h3_mask_max_fraction" value={t.h3_mask_max_fraction ?? 0.75} oninput={(e) => update('h3_mask_max_fraction', Number(e.target.value))} min={0} max={1} step="0.05" disabled={t.h3_mask_mode === 'off' && !t.h3_mask_audio} />
									</div>
								</div>
								<div class="grid grid-cols-1 md:grid-cols-2 gap-2">
