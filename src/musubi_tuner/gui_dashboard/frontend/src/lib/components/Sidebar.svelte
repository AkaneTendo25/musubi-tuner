<script>
	...
	const navItems = [
		...
		{ href: '/training', label: 'Training', group: 'Workflow', icon: 'M13 10V3L4 14h7v7l9-11h-7z', processTypes: ['training'] },
		...
		{ href: '/training/dashboard', label: 'Monitor', group: 'Workflow', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
