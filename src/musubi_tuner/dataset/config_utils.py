...
class ConfigSanitizer:
    ...
    AUDIO_DATASET_DISTINCT_SCHEMA = {
        "audio_directory": str, "audio_jsonl_file": str, "cache_directory": str,
        "lyrics_extension": str, "sample_rate": int, "max_duration": float, "min_duration": float,
        "duration_bucket_interval": float,
        "strict_cache_validation": bool,
    }
    ...
    def __init__(self) -> None:
        ...
        self.audio_dataset_schema = self.__merge_dict(self.DATASET_ASCENDABLE_SCHEMA, self.AUDIO_DATASET_DISTINCT_SCHEMA)
...
class BlueprintGenerator:
    ...
    def generate(self, user_config: dict, argparse_namespace: argparse.Namespace, **runtime_params) -> Blueprint:
        ...
        for dataset_config in sanitized_user_config.get("datasets", []):
            ...
            dataset_blueprints.append(DatasetBlueprint(is_image_dataset, params, dataset_type))
