...
from musubi_tuner.cosmos3.cosmos_framework.utils.flags import DEVICE, INTERNAL
from musubi_tuner.cosmos3.cosmos_framework.utils import log
from musubi_tuner.cosmos3.cosmos_framework.utils.easy_io import easy_io
from musubi_tuner.cosmos3.cosmos_framework.model.vfm.tokenizers.audio.avae_utils.env import AttrDict
from musubi_tuner.cosmos3.cosmos_framework.model.vfm.tokenizers.audio.avae_utils.models import load_generator
from musubi_tuner.cosmos3.cosmos_framework.model.vfm.tokenizers.interface import AudioTokenizerInterface
...
class AVAEInterface(AudioTokenizerInterface):
    ...
    def __init__(
        ...
        if not INTERNAL:
            if vae_path_full.startswith("s3://") or config_path_full.startswith("s3://"):
                raise ValueError("Object-store AVAE checkpoints are not supported by this local Cosmos package.")
