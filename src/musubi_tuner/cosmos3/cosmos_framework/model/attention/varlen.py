...
from musubi_tuner.cosmos3.cosmos_framework.model.attention.utils import is_torch_compiling
...
def generate_multi_dim_varlen_parameters(
    ...
    **Requires NATTEN >= 0.21.9.dev0**
    ...
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.natten import NATTEN_VARLEN_MULTI_DIM_VERSION, natten_supported, natten_version_satisfies
