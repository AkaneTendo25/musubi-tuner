...
from musubi_tuner.cosmos3.cosmos_framework.model.attention.utils.version import version_at_least
...
if FLASH3_SUPPORTED:
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.flash3.functions import flash3_attention

else:
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.flash3.stubs import flash3_attention
