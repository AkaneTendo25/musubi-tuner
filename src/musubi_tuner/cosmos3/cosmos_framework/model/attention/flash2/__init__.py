...
if FLASH2_SUPPORTED:
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.flash2.functions import flash2_attention

else:
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.flash2.stubs import flash2_attention
