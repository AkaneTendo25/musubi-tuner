...
if NATTEN_SUPPORTED:
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.natten.functions import (
        natten_attention,
    ...
    from musubi_tuner.cosmos3.cosmos_framework.model.attention.natten.stubs import (
        natten_attention,
        natten_multi_dim_attention,
        natten_multi_dim_attention_varlen,
    )
