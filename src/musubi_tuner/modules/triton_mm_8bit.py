"""Triton 8-bit matmul used by W8A8 backward.

This kernel handles a row-major RHS efficiently, which avoids storing a second
transposed int8 copy of every quantized Linear weight.
"""
